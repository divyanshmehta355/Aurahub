    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-8 gap-4">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white font-display tracking-tight self-start sm:self-center">
            Explore {activeCategory !== "All" && `- ${activeCategory}`}
          </h2>
          <div className="flex items-center space-x-3 self-end sm:self-center">
            <label htmlFor="sort" className="text-sm font-semibold text-gray-600 dark:text-gray-400">
              Sort by:
            </label>
            <select
              id="sort"
              ...
              className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 text-gray-800 dark:text-gray-100 font-medium rounded-xl shadow-sm pl-4 pr-8 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-all cursor-pointer"
            >
...
export default ExploreFeedClient;